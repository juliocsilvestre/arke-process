    ...
    const handleAttachWorkerToEventDay = useCallback(
        async (data: AttachWorkerToEventDayBody) => {
            try {
                ...
                form.reset();
                toast.success(
                    `${data.workers_id.length} funcionários adicionados ao dia ${
                        selectedDay + 1
                    } com sucesso!`
                );
            } catch (error: unknown) {
        ...
        <section className="bg-gray-50 min-h-screen overflow-y-auto p-4 md:p-10">
            ...
            <div className="details mt-[30px]">
                <p className="text-gray-600 text-sm">
                    <span className="font-bold">Começo:</span>{" "}
                    {formatEventPeriod(startDate as unknown as string)}
                </p>
                <p className="text-gray-600 text-sm">
                    <span className="font-bold">Fim:</span>{" "}
                    {formatEventPeriod(endDate as unknown as string)}
                </p>
            </div>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-col">
                                            ...
                                            <Popover
                                                open={isWorkersComboBoxOpen}
                                                onOpenChange={setIsWorkersComboBoxOpen}
                                            >
                                                                ...
                                                                <CommandItem
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        field.value.includes(
                                                                            ...
                                                                            "bg-success-500/10 text-gray-800"
                                                                    )}
                                                                    onSelect={() => {
                                                                        if (
                                                                            field.value.includes(
                                ...
                                <div className="flex flex-shrink-0 justify-end px-4 py-4 bg-white gap-2">
                                    ...
                                    <Button
                                        ...
                                        onClick={form.handleSubmit((data) =>
                                            handleAttachWorkerToEventDay(data)
                                        )}
                                    >
                                        Adicionar funcionários ao dia {selectedDay + 1}
                                    </Button>
