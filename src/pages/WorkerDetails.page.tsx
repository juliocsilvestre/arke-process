      ...
      <div className="max-w-[1200px]">
        ...
        <div className="worker-body mt-[32px]">
          <div className="worker-body__header">
            ...
            <div className="grid grid-cols-1 justify-items-center md:justify-items-start md:grid-cols-2 2xl:grid-cols-3 gap-y-4 gap-x-[6rem] mt-[16px]">
        ...
        <div className="worker-body mt-[32px]">
          <div className="worker-body__header">
            ...
            <div className="grid grid-cols-1 justify-items-center md:justify-items-start md:grid-cols-2 2xl:grid-cols-3 gap-y-2 gap-x-[6rem] mt-[16px]">
              <div className="md:text-left worker-detail-field">
                <Label
                  label="Rua"
                  className="inline mr-[4px] md:mr-0 md:block text-lg text-primary-600 font-semibold"
