    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 aria-selected:text-primary-400',
        ),
        ...
        day_range_middle:
          'aria-selected:bg-slate-100 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50 !bg-secondary-300 !rounded-none text-white',
        day_hidden: 'invisible',
        day_range_start: 'day-range-start !bg-secondary-300 rounded-r-none text-white',
        ...classNames,
      }}
      components={{
